<div id="php-rdg" class="app">
  ...
  <div>
    <p>
      <b>Implémentation simple du patron de conception Row Data Gateway pour PHP.</b><br />
      ...
      les inclure dans vos classes en les faisant hériter d'une classe de base.
    </p>
  </div>
